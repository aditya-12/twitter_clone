...
export const getUserProfile = async(req,res) => {
    ...
    try {
        const user = await User.findOne({username}).select("-passwprd");
        if (!user) {
...
export const followUnfollowUser = async(req,res) => {
    try {
        ...
        if (isFollowing) {
            ...
            // TOFO return the id of the user as a response
...
export const updateUser = async function name(req, res) {
    ...
    try {
        ...
        // added to check whether the username, the user want to update is already taken or not.
        ...
        // added to check whether the email, the user want to update is already taken or not.
